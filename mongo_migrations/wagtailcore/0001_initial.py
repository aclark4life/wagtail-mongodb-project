    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=models.SET(wagtail.models.get_default_page_content_type), related_name='pages', to='contenttypes.contenttype', verbose_name='content type')),
            ...
            bases=(wagtail.models.WorkflowMixin, wagtail.models.PreviewableMixin, wagtail.models.specific.SpecificMixin, wagtail.search.index.Indexed, models.Model),
        ),
        migrations.CreateModel(
            name='Workflow',
            fields=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('group', 'page', 'permission'), name='unique_permission'),
        ),
