"""
Database routers for this project.
...
class PostgreSQLRouter:
    ...
    When running MongoDB and PostgreSQL simultaneously, this router directs
    auth, admin, contenttypes, and sessions to PostgreSQL while application
    models use MongoDB via MongoRouter.

    Configure DATABASE_ROUTERS in settings as:
        DATABASE_ROUTERS = [
